...
describe("AqiDirect", function()
  it("should direct-load-aqi", function()
    local setup = aqi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-aqi", setup.live and "live" or "unit")
...
function aqi_direct_setup(mockres)
