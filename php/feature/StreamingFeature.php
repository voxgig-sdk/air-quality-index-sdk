...
// AirQualityIndex SDK streaming feature
...
class AirQualityIndexStreamingFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _iterate(AirQualityIndexResult $result): \Generator
    {
    ...
    private function _streamable(AirQualityIndexContext $ctx): bool
    {
