...
// AirQualityIndex SDK rbac feature
...
class AirQualityIndexRbacFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _required(AirQualityIndexContext $ctx): ?string
    {
    ...
    private function _reject(AirQualityIndexContext $ctx, string $required): void
    {
    ...
    private function _track(AirQualityIndexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
