...
// AirQualityIndex SDK netsim feature
...
class AirQualityIndexNetsimFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _simulate(AirQualityIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AirQualityIndexContext $ctx, array $applied): void
    {
        $client = $this->client;
