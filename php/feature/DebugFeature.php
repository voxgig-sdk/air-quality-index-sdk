...
// AirQualityIndex SDK debug feature
...
class AirQualityIndexDebugFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _finish(AirQualityIndexContext $ctx, bool $ok): void
    {
