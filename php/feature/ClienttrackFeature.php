...
// AirQualityIndex SDK clienttrack feature
...
class AirQualityIndexClienttrackFeature extends AirQualityIndexBaseFeature
{
    ...
    public function PostConstruct(AirQualityIndexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AirQualityIndex-SDK';
