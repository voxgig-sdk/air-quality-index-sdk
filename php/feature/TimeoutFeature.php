...
// AirQualityIndex SDK timeout feature
...
class AirQualityIndexTimeoutFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _with_timeout(AirQualityIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AirQualityIndexContext $_ctx, float $ms): void
    {
        $client = $this->client;
