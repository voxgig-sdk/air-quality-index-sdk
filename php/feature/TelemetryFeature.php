...
// AirQualityIndex SDK telemetry feature
...
class AirQualityIndexTelemetryFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _close(AirQualityIndexContext $ctx, bool $ok): void
    {
