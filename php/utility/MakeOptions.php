...
// AirQualityIndex SDK utility: make_options

class AirQualityIndexMakeOptions
{
    ...
    public static function call(AirQualityIndexContext $ctx): array
    {
        ...
        //
        // `AirQualityIndexSchema::optspec()` is built from the model:
        ...
        $optspec = AirQualityIndexSchema::optspec();
