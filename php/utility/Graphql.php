...
// AirQualityIndex SDK utility: graphql
//
...
class AirQualityIndexGraphql
{
    ...
    // equivalent.
    public static function body(AirQualityIndexContext $ctx): mixed
    {
    ...
    public static function errors(AirQualityIndexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
