...
class AirQualityIndexMakeRequest
{
    public static function call(AirQualityIndexContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AirQualityIndexResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AirQualityIndexResponse($fetched);
        } else {
