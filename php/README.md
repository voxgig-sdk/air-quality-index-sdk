...
The PHP SDK for the AirQualityIndex API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Aqi(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->AirQualityIndex(null)->load(
    ["id" => "test01"], null
);
