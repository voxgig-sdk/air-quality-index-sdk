...
// AirQualityIndex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AirQualityIndexSDK::test)
...
{
    private const SDK_CLASS = 'AirQualityIndexSDK';
    ...
    private const SDK_BASE = 'airqualityindex_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../airqualityindex_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
