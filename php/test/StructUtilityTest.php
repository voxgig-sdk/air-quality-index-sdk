...
// AirQualityIndex SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AirQualityIndexOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AirQualityIndexOmni::structfix($now, Struct::undef()))
                        !== json_encode(AirQualityIndexOmni::structfix($val, Struct::undef()))) {
