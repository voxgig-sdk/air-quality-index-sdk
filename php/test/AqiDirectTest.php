...
class AqiDirectTest extends TestCase
{
    public function test_direct_load_aqi(): void
    {
        $setup = aqi_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-aqi", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
