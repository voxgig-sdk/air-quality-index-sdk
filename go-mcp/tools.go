...
type Args struct {
	Entity string         `json:"entity" jsonschema:"aqi"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AirQualityIndexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "air-quality-index_list",
		Description: "List records from AirQualityIndex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "air-quality-index_load",
		Description: "Load a single record from AirQualityIndex. " +
...
func runOp(client *sdk.AirQualityIndexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AirQualityIndexSDK, name string) (sdk.AirQualityIndexEntity, error) {
	switch strings.ToLower(name) {
	case "aqi":
		return client.Aqi(nil), nil
