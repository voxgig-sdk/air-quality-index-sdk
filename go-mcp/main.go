// Command AirQualityIndex-mcp is an MCP server exposing the AirQualityIndex
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AirQualityIndex_list  — list records of an entity
//	AirQualityIndex_load  — load a single record of an entity
//
