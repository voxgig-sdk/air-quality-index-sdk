...
(0, node_test_1.describe)('AqiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AirQualityIndexSDK({
    ...
    (0, node_test_1.test)('direct-load-aqi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-aqi', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AIR_QUALITY_INDEX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AirQualityIndexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.AIR_QUALITY_INDEX_APIKEY,
        }));
        let idmap = env['AIR_QUALITY_INDEX_TEST_AQI_ENTID'];
    ...
    const client = new __1.AirQualityIndexSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AqiDirect.test.js.map