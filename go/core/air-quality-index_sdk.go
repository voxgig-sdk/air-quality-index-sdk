...
type AirQualityIndexSDK struct {
	Mode     string
...
func (sdk *AirQualityIndexSDK) OptionsMap() map[string]any {
...
func (sdk *AirQualityIndexSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AirQualityIndexSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AirQualityIndexSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AirQualityIndexSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AirQualityIndexSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AirQualityIndexSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AirQualityIndexSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AirQualityIndexSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AirQualityIndexSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AirQualityIndexSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AirQualityIndexSDK {
	...
	sdk := NewAirQualityIndexSDK(sdkopts)
	sdk.Mode = "test"
