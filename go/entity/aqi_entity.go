...
type AqiEntity struct {
	name    string
	client  *core.AirQualityIndexSDK
...
func NewAqiEntity(client *core.AirQualityIndexSDK, entopts map[string]any) *AqiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AqiEntity) GetName() string { return e.name }
...
func (e *AqiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AqiEntity) Deleted() bool {
	return e.deleted
}


func (e *AqiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAqiEntity(e.client, opts)
}

func (e *AqiEntity) Data(args ...any) any {
...
func (e *AqiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Aqi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AqiEntity) DataTyped(data ...Aqi) Aqi {
	if len(data) > 0 {
		return typedFrom[Aqi](e.Data(asMap(data[0])))
	}
	return typedFrom[Aqi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Aqi (all fields
// optional at the wire level).
func (e *AqiEntity) MatchTyped(match ...Aqi) Aqi {
	if len(match) > 0 {
		return typedFrom[Aqi](e.Match(asMap(match[0])))
	}
	return typedFrom[Aqi](e.Match())
}
...
func (e *AqiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AqiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AqiLoadMatch and returns an Aqi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AqiEntity) LoadTyped(reqmatch AqiLoadMatch, ctrl map[string]any) (Aqi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Aqi{}, err
	}
	return typedFrom[Aqi](res), nil
}



func (e *AqiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AqiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AqiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AqiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AqiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
