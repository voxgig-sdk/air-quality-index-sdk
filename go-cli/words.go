...
func registerSDKWords(r *eng.Registry, client *sdk.AirQualityIndexSDK) {
...
func runOp(client *sdk.AirQualityIndexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
