...
AQL-driven CLI and REPL for the AirQualityIndex SDK. Positional arguments are
...
```sh
go build -o air-quality-index-cli ./...
```
...
./air-quality-index-cli list aqi
./air-quality-index-cli load 1 aqi
./air-quality-index-cli load '{id:1}' aqi
