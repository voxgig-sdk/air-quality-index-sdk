...
#      offline in seeded test mode (AirQualityIndexSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AirQualityIndex_sdk.rb")
  SDK_CLASS = "AirQualityIndexSDK"
