...
from airqualityindex_sdk.core.control import AirQualityIndexControl
...
from airqualityindex_sdk.core.helpers import get_ctx_prop, to_map
...
class AirQualityIndexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AirQualityIndexControl()
        ...
        if isinstance(sp, AirQualityIndexSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AirQualityIndexResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AirQualityIndexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AirQualityIndexOperation({})
    ...
    def make_error(self, code, msg):
        return AirQualityIndexError(code, msg, self)
