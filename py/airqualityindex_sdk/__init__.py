...
from airqualityindex_sdk.utility import register

# Load features
from airqualityindex_sdk.feature.base_feature import AirQualityIndexBaseFeature
from airqualityindex_sdk.features import _has_feature, _make_feature
...
class AirQualityIndexSDK:
    ...
    def get_utility(self):
        return AirQualityIndexUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AirQualityIndexSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Aqi(self, data=None) -> "AqiEntity":
        ...
        from airqualityindex_sdk.entity.aqi_entity import AqiEntity
