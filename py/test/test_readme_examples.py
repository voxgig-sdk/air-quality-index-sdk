# AirQualityIndex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AirQualityIndexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AirQualityIndexSDK(...) and AirQualityIndexSDK.test(...) become
#      AirQualityIndexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "airqualityindex_sdk"
_SDK_CLASS = "AirQualityIndexSDK"
