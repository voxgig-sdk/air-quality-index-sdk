...
|---|---|---|
| `ts/` | @voxgig-sdk/air-quality-index-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/air-quality-index-sdk \
      --repository voxgig-sdk/air-quality-index-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/air-quality-index-sdk` shows it, and
`npm trust revoke @voxgig-sdk/air-quality-index-sdk --id=<id>` removes it.
