...
// AirQualityIndex SDK utility: fetcher

class AirQualityIndexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AirQualityIndexSDK/1.0)';
    ...
    public static function call(AirQualityIndexContext $ctx, string $fullurl, array $fetchdef): array
    {
