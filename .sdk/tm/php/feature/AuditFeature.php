...
// AirQualityIndex SDK audit feature
...
class AirQualityIndexAuditFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _emit(AirQualityIndexContext $ctx, string $outcome): void
    {
