...
// AirQualityIndex SDK metrics feature
...
class AirQualityIndexMetricsFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _record(AirQualityIndexContext $ctx, bool $ok): void
    {
