...
// AirQualityIndex SDK idempotency feature
...
class AirQualityIndexIdempotencyFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _mutating(AirQualityIndexContext $ctx): bool
    {
