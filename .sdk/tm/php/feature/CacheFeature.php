...
// AirQualityIndex SDK cache feature
...
class AirQualityIndexCacheFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _through(AirQualityIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
