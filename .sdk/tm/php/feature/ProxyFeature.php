...
// AirQualityIndex SDK proxy feature
...
class AirQualityIndexProxyFeature extends AirQualityIndexBaseFeature
{
    ...
    public function init(AirQualityIndexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AirQualityIndexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
