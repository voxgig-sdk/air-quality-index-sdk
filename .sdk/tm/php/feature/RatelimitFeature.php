...
// AirQualityIndex SDK ratelimit feature
...
class AirQualityIndexRatelimitFeature extends AirQualityIndexBaseFeature
{
    ...
    private function _acquire(AirQualityIndexContext $ctx): void
    {
    ...
    private function _track(AirQualityIndexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
