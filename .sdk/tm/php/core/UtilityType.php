...
// AirQualityIndex SDK utility type

class AirQualityIndexUtility
{
    ...
    public static function copy(AirQualityIndexUtility $src): AirQualityIndexUtility
    {
        $u = new AirQualityIndexUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
