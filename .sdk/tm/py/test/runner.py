...
class AirQualityIndexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AirQualityIndexTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AirQualityIndexTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AirQualityIndexTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
